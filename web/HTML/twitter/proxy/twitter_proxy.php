...
$config['base_url'] = 'http://api.twitter.com/1.1/';
...
$url = 'statuses/user_timeline.json?screen_name=' . $config['username'] . '&count=' . $config['limit'] . '&include_rts=false&exclude_replies='.(!$config['with_replies']);
